...
use crate::{ AppState, entity::permission::{CreatePermission, Permission}, error::{AppError, AppErrorType}, dto::pagination::PaginationRequest };
        ...
        Err(e) => {
            ...
            match e {
                sqlx::Error::RowNotFound => {
                    let empty: Vec<Permission> = Vec::with_capacity(0);
